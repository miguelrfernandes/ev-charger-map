...
def __(ProfileReport, pd):
    ...
    df_INE
    return df_INE, profile_INE, url_INE
...
def __(ProfileReport, pd):
    ...
    url_INE_income = "data/ine_indicador_0011627 old.csv" 
    df_INE_income = pd.read_csv(url_INE_income, sep=";")


    profile_INE_income = ProfileReport(df_INE_income, title="Profiling Report INE Income")
    profile_INE_income.to_file("reports/profile_INE_income.html")

    df_INE_income
    return df_INE_income, profile_INE_income, url_INE_income
...
def __(ProfileReport, pd):
    ...
    df_EREDES
    return df_EREDES, profile_EREDES, url_EREDES
